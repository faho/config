function __fish_has_systemctl
	type systemctl > /dev/null ^/dev/null
	return $status
end
...
function __fish_systemctl_mounts
	...
	if __fish_has_systemctl
		systemctl $USERMODE list-unit-files --no-legend --type=mount ^/dev/null | cut -f 1 -d ' '
	end
end
...
function __fish_systemctl_service_paths
	...
	if __fish_has_systemctl
		systemctl $USERMODE list-unit-files --no-legend --type=path ^/dev/null | cut -f 1 -d ' '
	end
end
...
function __fish_systemctl_services
	...
	if __fish_has_systemctl
		systemctl $USERMODE list-unit-files --no-legend --type=service ^/dev/null | cut -f 1 -d ' '
	end
end
...
function __fish_systemctl_sockets
	...
	if __fish_has_systemctl
		systemctl $USERMODE list-unit-files --no-legend --type=socket ^/dev/null | cut -f 1 -d ' '
	end
end
